...
STATE_FILE = Path(__file__).parent / "scopus_search_state.json"
PROGRESS_FILE = Path(__file__).parent / "scopus_search_progress.json"
...
SEARCH_PROGRESS = PROJECT_ROOT / "search_progress.json"  # pipeline principal
SCOPUS_RESULTS_DIR = PROJECT_ROOT / "scopus_results"
