...
class PipelineManager:
    ...
    def __init__(self, config: PipelineConfig):
        self.config = config
        self.status_file = config.project_root / "outputs" / "state" / "pipeline_status.json"
        self.state_file = config.project_root / "outputs" / "state" / "pipeline_state.json"
    ...
    def _step_search_articles(self) -> dict[str, Any]:
        ...
        progress_file = self.config.project_root / "outputs" / "state" / "search_progress.json"
    ...
    def _step_download_pdfs(self) -> dict[str, Any]:
        ...
        progress_file = self.config.project_root / "outputs" / "state" / "download_progress.json"
